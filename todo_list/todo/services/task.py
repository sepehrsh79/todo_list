...
def create_task(*, title: str, description: str, board: Board, deadline: datetime.date | None,  user: BaseUser) -> Task:
    try:
        return Task.objects.create(title=title, description=description, board=board, deadline=deadline, user=user)
